...
import (
	...
	"argon.github.io/ingress/internal/controller"
...
func init() {
	...
	// utilruntime.Must(argonv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if secureMetrics {
		...
		// can access the metrics endpoint. The RBAC are configured in 'config/rbac.yaml/kustomization.yaml'. More info:
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "56f925b7.argon.github.io",
	...
	hub := grpc.NewStreamHub()
	if err := (&controller.ArgonConfigReconciler{
		Client:       mgr.GetClient(),
		Scheme:       mgr.GetScheme(),
		IngressClass: ingressClass,
		StreamHub:    hub,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ArgonConfig")
		os.Exit(1)
	}
